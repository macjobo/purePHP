...
<head> 
  ...
  <title>Porsche Informatik August 2014</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter August 2014" />
...
<li>CROSS
	...
	<li <? if($page == "wit") echo "class='selected'";?> >
          <a href="index.php?page=wit" onmouseover="window.status='CROSS.Controlling Datenfilterung'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">CROSS.Controlling Datenfilterung</a>		
	 		</li>
	...
	<li <? if($page == "jel") echo "class='selected'";?> >
          <a href="index.php?page=jel" onmouseover="window.status='Seminartermine 2. Halbjahr 2014'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Seminartermine 2. Halbjahr 2014</a>		
	 		</li>
...
<!--	
	...
	<ul>
          ...
          <a href="index.php?page=mal2" onmouseover="window.status='IT-Sicherheit: Erneute Spamwelle'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">IT-Sicherheit: Erneute Spamwelle</a>		
	 		</li>
