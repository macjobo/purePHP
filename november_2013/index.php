...
<ul>	 
	...
	<li <? if($page == "wag") echo "class='selected'";?> >
		...
		<li <? if($page == "wag1") echo "class='selected'";?> >
          <a href="index.php?page=wag1" onmouseover="window.status='CROSS: Die Barcode-Lösung'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">CROSS.Barcode</a>		
	 		</li>	
