...
<head> 
  ...
  <title>Porsche Informatik Juli 2014</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter Juli 2014" />
...
<ul>	 
	...
	<li <? if($page == "wit") echo "class='selected'";?> >
          <a href="index.php?page=wit" onmouseover="window.status='Der Teilebereich ist Chefsache!'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Der Teilebereich ist Chefsache!</a>		
	 		</li>
		
					<li <? if($page == "arn") echo "class='selected'";?> >
          <a href="index.php?page=arn" onmouseover="window.status='CROSS.Service.Auftragsweitergabe'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">CROSS.Service.Auftragsweitergabe</a>		
	 		</li>
...
<!--	
	...
	<ul>
          ...
          <a href="index.php?page=jel" onmouseover="window.status='POCSO: WLAN-Accesspoints für Draußen'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">WLAN-Accesspoints für Draußen</a>		
	 		</li>
