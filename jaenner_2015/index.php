...
<head> 
  ...
  <title>Porsche Informatik Jänner 2015</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter Jänner 2015" />
...
<li>CROSS Beratung und Training
	...
	<li <? if($page == "jel") echo "class='selected'";?> >
          <a href="index.php?page=jel" onmouseover="window.status='Seminartermine 1. Halbjahr 2015'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Seminartermine 1. Halbjahr 2015</a>		
	 		</li>		
	...
	<li <? if($page == "mal1") echo "class='selected'";?> >
          ...
          <a href="index.php?page=mal2" onmouseover="window.status='POCSO: Ende Windows XP'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Ende Windows XP</a>		
	 		</li>		
	...
	<li <? if($page == "mal3") echo "class='selected'";?> >
          <a href="index.php?page=mal3" onmouseover="window.status='Erneute Spamwelle - Online Training Informationssicherheit'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Erneute Spamwelle - Online Training Informationssicherheit</a>		
	 		</li>				
