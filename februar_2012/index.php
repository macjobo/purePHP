...
<head> 
  ...
  <title>Porsche Informatik Februar 2012</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter Februar 2012" />
...
<li>CROSS Release 2.19
	<ul>		
	
		<li <? if($page == "ric") echo "class='selected'";?> >
          <a href="index.php?page=ric" onmouseover="window.status='Vorschau Allgemein und NW/GW'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Vorschau CRM und NW/GW</a>		
	 		</li>		
...
<li>CROSS
	<ul>
		...
		<li <? if($page == "wag2") echo "class='selected'";?> >
          <a href="index.php?page=wag2" onmouseover="window.status='Tipp: Eingangsrechnungskontrolle'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Tipp: Eingangsrechnungskontrolle</a>		
	 		</li>		
...
<li>Hardware
	<ul>	
		<li <? if($page == "mal2") echo "class='selected'";?> >
          <a href="index.php?page=mal2" onmouseover="window.status='Neue Epson-Kassenhardware'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Neue Epson-Kassenhardware</a>				 	
		</li>			
