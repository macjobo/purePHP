...
<head> 
  ...
  <title>Porsche Informatik September 2014</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter September 2014" />
...
<li>Anwendungen
	...
	<li <? if($page == "wit") echo "class='selected'";?> >
          <a href="index.php?page=wit" onmouseover="window.status='Zentrale Begutachtungsdatenbank'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Zentrale Begutachtungsdatenbank</a>		
	 		</li>
...
<li>CROSS Tipp
	...
	<li <? if($page == "arn") echo "class='selected'";?> >
          <a href="index.php?page=arn" onmouseover="window.status='Reifenselektion/Reifenpreisliste'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Reifenselektion/Reifenpreisliste</a>		
	 		</li>
	...
	<ul>
          ...
          <a href="index.php?page=mal" onmouseover="window.status='POCSO: Diagnosetester selbst installieren'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Diagnosetester selbst installieren</a>		
	 		</li>
