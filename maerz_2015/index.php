...
<head> 
  ...
  <title>Porsche Informatik März 2015</title>  
</head>
...
<li>CROSS
	...
	<li <? if($page == "jel") echo "class='selected'";?> >
          <a href="index.php?page=jel" onmouseover="window.status='Freie Plätze CROSS- und SAP-Seminare im März'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Freie Plätze CROSS- und SAP-Seminare</a>		
	 		</li>
