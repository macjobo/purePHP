...
<head> 
  ...
  <title>Porsche Informatik März 2012</title>  
</head>
...
<li>CROSS
	<ul>
		...
		<li <? if($page == "klb") echo "class='selected'";?> >
          ...
          <a href="index.php?page=wag" onmouseover="window.status='Änderung CROSS-Infos mit 2.19'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Änderung "CROSS-Infos" mit 2.19</a>		
	 		</li>		
