...
<ul>	 
	...
	<li <? if($page == "wag") echo "class='selected'";?> >
         <a href="index.php?page=wag" onmouseover="window.status='Eingangsrechnungskontrolle II'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Eingangsrechnungskontrolle Teil II</a>				 	
		</li>
...
<li>POCSO
	<ul>
          ...
          <a href="index.php?page=mal1" onmouseover="window.status='Neue Porsche Premium-Datenleitungen'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Neue Porsche-Premium Datenleitungen</a>		
	 		</li>		
...
<li>NOTES
	<ul>
          ...
          <a href="index.php?page=pri" onmouseover="window.status='Rechtschreibprüfung in Lotus Notes'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Rechtschreibprüfung in Lotus Notes</a>		
	 		</li>		
