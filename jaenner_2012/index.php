...
<head> 
  ...
  <title>Porsche Informatik Jänner 2012</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter Jänner 2012" />
...
<li>CROSS
	<ul>
		...
		<li <? if($page == "wag") echo "class='selected'";?> >
          <a href="index.php?page=wag" onmouseover="window.status='Auftragsdruck mittels Laserdrucker'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Auftragsdruck mittels Laserdrucker</a>		
	 		</li>		
	
	
		<li <? if($page == "wit") echo "class='selected'";?> >
          <a href="index.php?page=wit" onmouseover="window.status='Datenaustausch im Service-Prozess'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Datenaustausch im Service-Prozess</a>		
	 		</li>		
	</ul>
</li>
...
<li>Hardware
	<ul>	
		<li <? if($page == "wit2") echo "class='selected'";?> >
          <a href="index.php?page=wit2" onmouseover="window.status='Vorteile von SSD-Laufwerken'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Vorteile von SSD-Laufwerken</a>				 	
		</li>			
