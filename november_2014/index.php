...
<li>CROSS
	...
	<li <? if($page == "klb1") echo "class='selected'";?> >
          <a href="index.php?page=klb1" onmouseover="window.status='Neuer Verkäuferarbeitsplatz in China'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Neuer Verkäuferarbeitsplatz in China</a>		
	 </li>		
