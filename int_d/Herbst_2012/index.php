...
<li>POCSO
	<ul>			
          ...
          <a href="index.php?page=lo" onmouseover="window.status='POCSO-Teleworker neu'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">POCSO-Teleworker neu</a>				 			
	 			</li>
          ...
          <a href="index.php?page=lo2" onmouseover="window.status='Vorstellung neuer Mitarbeiter'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Vorstellung neuer Mitarbeiter</a>				 			
	 			</li>	
