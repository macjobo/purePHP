...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter Juni 2011" />
	...
	<!-- 
WAG: CROSS Tipp?? Neue Ablaufbeschreibung zu irgendeinem Thema?
KCH (bzw. Rollouter mit Erfahrung damit): Eingangsrechnungskontrolle - Erfahrungen nach knapp 1 Jahr Einsatz
...
<li>CROSS
	<ul>		
          ...
          <a href="index.php?page=ric2" onmouseover="window.status='Rückschau Anwendertage 2011'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Rückschau Anwendertage 2011</a>		
	 		</li>		
...
<li>Service Desk
	<ul>	
		...
		<li <? if($page == "alk") echo "class='selected'";?> >
          <a href="index.php?page=alk" onmouseover="window.status='Neue Mitarbeiter'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Neue Mitarbeiter</a>				 	
		</li>				
