...
<head> 
  ...
  <title>Neuigkeiten der Porsche Informatik - Winter 2008</title>  
</head>
...
<ul>	        
	...
	<li>Schulungen
          ...
          <a href="index.php?page=hg" onmouseover="window.status='Microsoft Office'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Microsoft Office</a>
        	</li>									
			</ul>
 	</li>		
	...
	<li>Lotus Notes
          ...
          <a href="index.php?page=hg1" onmouseover="window.status='Vorschau auf Version 7.0'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">BlackBerry&reg; Enterprise Mobile User</a>				 			
	 				</li>			 			
	 			</ul>
	</li>
   	...
   	<li>Notebook 
          ...
          <a href="index.php?page=lo1" onmouseover="window.status='Surfen über WLAN Hotspot'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Internetzugriff über WLAN-Hotspot</a>				 			
	 				</li>							 			
	 			</ul>
		</li>
