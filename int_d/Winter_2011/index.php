...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Neuigkeiten Winter 2011" />
...
<li>IT-Sicherheit
	<ul>
          ...
          <a href="index.php?page=spi" onmouseover="window.status='Kennwortaktivierung BlackBerry'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Kennwortaktivierung BlackBerry</a>				 			
	 			</li>	
				
				<li <? if($page == "spi2") echo "class='selected'";?> >
          <a href="index.php?page=spi2" onmouseover="window.status='Automatischer Bildschirmschoner'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Automatischer Bildschirmschoner</a>				 			
	 			</li>	
