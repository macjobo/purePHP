...
<head> 
  ...
  <title>Porsche Informatik April 2013</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter April 2013" />
...
<ul>	 
	...
	<li <? if($page == "wag") echo "class='selected'";?> >
         <a href="index.php?page=wag" onmouseover="window.status='Verrechnungsgrad'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Serie: Verrechnungsgrad</a>				 	
		</li>
		
			
			<li <? if($page == "wit") echo "class='selected'";?> >
          <a href="index.php?page=wit" onmouseover="window.status='CROSS.Controlling.Service'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Serie: CROSS.Controlling.Service</a>		
	 		</li>	
...
<!--	
	...
	<li <? if($page == "mal1") echo "class='selected'";?> >
         <a href="index.php?page=mal1" onmouseover="window.status='E-Versicherung POCSO Diagnosetester'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">E-Versicherung POCSO Diagnosetester</a>				 	
		</li>
...
<li>SERVICE DESK
	<ul>
          ...
          <a href="index.php?page=alk" onmouseover="window.status='Multibankensysteme'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Multibankensysteme</a>		
	 		</li>		
