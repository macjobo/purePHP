...
<head> 
  ...
  <title>Porsche Informatik Februar 2015</title>  
</head>
...
<li>CROSS
	...
	<li <? if($page == "bj") echo "class='selected'";?> >
          <a href="index.php?page=bj" onmouseover="window.status='Barcode Stempellösung'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">CROSS: Barcode Stempellösung</a>		
	 		</li>		
	
	<li <? if($page == "scc") echo "class='selected'";?> >
          <a href="index.php?page=scc" onmouseover="window.status='Mitarbeiter Ein- bzw. Austritt'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">CROSS-Tipp: Mitarbeiter Ein- bzw. Austritt</a>		
	 		</li>	
	
	<li <? if($page == "pri") echo "class='selected'";?> >
          <a href="index.php?page=pri" onmouseover="window.status='Neue Gesichter in der CROSS-Beratung'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Neue Gesichter in der CROSS-Beratung</a>		
	 		</li>	
	...
	<li <? if($page == "jel") echo "class='selected'";?> >
          <a href="index.php?page=jel" onmouseover="window.status='Freie Plätze CROSS-Seminare im Februar'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Freie Plätze CROSS-Seminare</a>		
	 		</li>
