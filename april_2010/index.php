...
<li>CROSS
	<ul>			
          ...
          <a href="index.php?page=pri" onmouseover="window.status='Anwendertage 2010'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Anwendertage 2010</a>				 			
	 		</li>		
			
			
			<li <? if($page == "wag") echo "class='selected'";?> >
          <a href="index.php?page=wag" onmouseover="window.status='Tipp: Gewährleistungsvergütung'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Tipp: Gewährleistungsvergütung</a>				 			
	 		</li>		
