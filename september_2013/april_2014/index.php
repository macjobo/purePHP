...
<ul>	 
	...
	<li <? if($page == "wit") echo "class='selected'";?> >
         <a href="index.php?page=wit" onmouseover="window.status='Tipp: xxxx'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Tipp: xxx</a>				 	
		</li>
...
<li>PHS
	...
	<li <? if($page == "pri") echo "class='selected'";?> >
          <a href="index.php?page=pri" onmouseover="window.status='Neues Gesicht'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Neues Gesicht</a>		
	 		</li>	
