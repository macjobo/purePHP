...
<li>CROSS
	<ul>		
          ...
          <a href="index.php?page=wag" onmouseover="window.status='Tipp: Wartung von Maßeinheiten'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Tipp: Wartung von Maßeinheiten</a>		
	 		</li>		
...
<li>Hardware
	<ul>
          ...
          <a href="index.php?page=kra1" onmouseover="window.status='Lieferengpässe'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Lieferengpässe</a>				 			
	 		</li>		
	</ul>
</li>		
