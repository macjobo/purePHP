...
<li>CROSS
	...
	<li <? if($page == "jel1") echo "class='selected'";?> >
          <a href="index.php?page=jel1" onmouseover="window.status='CROSS: MSA für SEAT und Skoda'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">MSA für SEAT und Skoda</a>		
	 		</li>
			
						
	<li <? if($page == "wit") echo "class='selected'";?> >
          <a href="index.php?page=wit" onmouseover="window.status='CROSS-Tipp: CROSS.Controlling Betriebs- und Serviceübersicht'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">CROSS.Controlling Betriebs- und Serviceübersicht</a>		
	 		</li>					
	...
	<li <? if($page == "mal2") echo "class='selected'";?> >
          <a href="index.php?page=mal2" onmouseover="window.status='POCSO: Übersiedelung Backup-Rechenzentrum'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Übersiedelung Backup-Rechenzentrum</a>		
	 		</li>
