...
<head> 
  ...
  <title>Porsche Informatik Februar 2014</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter Februar 2014" />
...
<ul>	 
	...
	<li <? if($page == "wit") echo "class='selected'";?> >
         <a href="index.php?page=wit" onmouseover="window.status='CROSS: Zubehöranalyse'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Zubehöranalyse</a>				 	
		</li>
		
		<li <? if($page == "wit1") echo "class='selected'";?> >
          <a href="index.php?page=wit1" onmouseover="window.status='CROSS: EBV-Mängelkatalog PLUS premium'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">EBV-Mängelkatalog PLUS premium</a>		
	 		</li>	
...
<!--	
	...
	<li <? if($page == "mal") echo "class='selected'";?> >
          <a href="index.php?page=mal" onmouseover="window.status='POCSO: Neue PC-Modelle'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Neue PC-Modelle</a>		
	 		</li>	
...
<!--	
	...
	<ul>
          ...
          <a href="index.php?page=let" onmouseover="window.status='POCSO: Backup'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Änderungen im UVA-Formular</a>		
	 		</li>	
