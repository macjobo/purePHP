...
<head> 
  ...
  <title>Porsche Informatik Neuigkeiten Frühjahr 2015</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Neuigkeiten Frühjahr 2015" />
...
<li>Infrastruktur
	<ul>
          ...
          <a href="index.php?page=spi" onmouseover="window.status='Gäste-WLAN Neu'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Gäste-WLAN Neu</a>				 			
	 			</li>		
				
					<li <? if($page == "lo") echo "class='selected'";?> >
          <a href="index.php?page=lo" onmouseover="window.status='Jahresrückblick Client-Team'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Jahresrückblick Client-Team</a>				 			
	 			</li>		
...
<li>Support
	<ul>
          ...
          <a href="index.php?page=alk2" onmouseover="window.status='Jahresrückblick Service Desk 2014'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Jahresrückblick Service Desk</a>				 			
	 			</li>		
