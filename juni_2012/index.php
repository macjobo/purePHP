...
<head> 
  ...
  <title>Porsche Informatik Juni 2012</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter Juni 2012" />
...
<li>CROSS Tipps
	<ul>
          ...
          <a href="index.php?page=wag" onmouseover="window.status='Termineinladungen im Webdesign'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Termineinladungen im Webdesign</a>		
	 		</li>		
			
				<li <? if($page == "wag2") echo "class='selected'";?> >
          <a href="index.php?page=wag2" onmouseover="window.status='CROSS-Archiv und Rechnungsvordrucke'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">CROSS-Archiv und Rechnungsvordrucke</a>		
	 		</li>				
...
<li>SAP
	<ul>
          ...
          <a href="index.php?page=gri" onmouseover="window.status='Papierlose Lohnabrechnung'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">"Papierlose" Lohnabrechnung</a>		
	 		</li>		
...
<li>POCSO
	<ul>	
          ...
          <a href="index.php?page=kra" onmouseover="window.status='Einsatz Volkswagen BTAC-Box'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Einsatz Volkswagen BTAC-Box</a>				 	
		</li>	
