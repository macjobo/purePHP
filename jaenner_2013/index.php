...
<head> 
  ...
  <title>Porsche Informatik Jänner 2013</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter Jänner 2013" />
...
<ul>	 
	...
	<ul>
		...
		<li <? if($page == "wit") echo "class='selected'";?> >
          <a href="index.php?page=wit" onmouseover="window.status='CROSS.Controlling.Service'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">CROSS.Controlling.Service</a>		
	 		</li>	
...
<!--	
	...
	-->		
         ...
         <a href="index.php?page=wag" onmouseover="window.status='Eingangsrechnungskontrolle'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Eingangsrechnungskontrolle</a>				 	
		</li>
			
			
			<li <? if($page == "wag1") echo "class='selected'";?> >
         <a href="index.php?page=wag1" onmouseover="window.status='Mechanikerproduktivitätsgrad'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Mechanikerproduktivitätsgrad</a>				 	
		</li>
...
<li>POCSO
	<ul>
		...
		<li <? if($page == "mim") echo "class='selected'";?> >
         <a href="index.php?page=mim" onmouseover="window.status='Sicherheitstipp: Passwörter'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Sicherheitstipp: Passwörter</a>				 	
		</li>		
...
<li>Service Desk
	<ul>
		...
		<li <? if($page == "alk") echo "class='selected'";?> >
          <a href="index.php?page=alk" onmouseover="window.status='"Mein Auto" - rundum mobil!'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">"Mein Auto" - rundum mobil!</a>		
	 		</li>	
