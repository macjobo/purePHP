...
<head> 
  ...
  <title>Porsche Informatik Mai 2013</title>  
</head>
...
<div id="inhalt">
   ...
   <img src="images/monat.jpg" width="260" height="150" border="0" title="Newsletter Mai 2013" />
...
<ul>	 
	...
	<li <? if($page == "wag") echo "class='selected'";?> >
         <a href="index.php?page=wag" onmouseover="window.status='Verrechnungsgrad Teil II'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Serie: Verrechnungsgrad Teil II</a>				 	
		</li>
		
			
			<li <? if($page == "wit") echo "class='selected'";?> >
          <a href="index.php?page=wit" onmouseover="window.status='CROSS.Controlling.Service Teil II'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Serie: CROSS.Controlling.Service Teil II</a>		
	 		</li>	
				
		<li <? if($page == "wag1") echo "class='selected'";?> >
          <a href="index.php?page=wag1" onmouseover="window.status='Fahrerdatenerfassung'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Fahrerdatenerfassung</a>		
	 		</li>			
...
<!--	
	...
	<li <? if($page == "mal") echo "class='selected'";?> >
		...
		<li <? if($page == "kab") echo "class='selected'";?> >
         <a href="index.php?page=kab" onmouseover="window.status='POCSO-Security'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">E-Mail Sicherheit</a>				 	
		</li>
