...
<li>Service Desk
	<ul>	
		...
		<li <? if($page == "alk") echo "class='selected'";?> >
          <a href="index.php?page=alk" onmouseover="window.status='Neue Mitarbeiter für wachsende Aufgaben'; return true;"  onmouseout="window.status='Porsche Informatik'; return true;">Neue Mitarbeiter für wachsende Aufgaben</a>				 	
		</li>			
